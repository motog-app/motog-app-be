...
async def optimize_image(file, max_size=(1024, 1024), quality=85):
    """
    Optimizes an image by resizing, auto-rotating (based on EXIF), converting to JPEG, and compressing it.
    ...
    # Fix rotation using EXIF data (important for iPhone/camera images)
